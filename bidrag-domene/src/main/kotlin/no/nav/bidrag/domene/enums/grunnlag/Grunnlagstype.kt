...
enum class Grunnlagstype {
    ...
    DELBEREGNING_BPS_BEREGNEDE_TOTALBIDRAG,
    DELBEREGNING_VOKSNE_I_HUSSTAND,

    @Deprecated(
        "Bruk DELBEREGNING_BIDRAGSPLIKTIGES_ANDEL_SÆRBIDRAG i stedet",
        replaceWith = ReplaceWith("DELBEREGNING_BIDRAGSPLIKTIGES_ANDEL_SÆRBIDRAG"),
    )
