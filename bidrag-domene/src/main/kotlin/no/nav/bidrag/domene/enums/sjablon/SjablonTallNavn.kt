...
enum class SjablonTallNavn(
    ...
    INNTEKTSINTERVALL_TILLEGGSBIDRAG_BELØP(
        "InntektsintervallTilleggsbidragBeløp",
        "0007",
        false,
        false,
        false,
    ...
    UNDERHOLD_EGNE_BARN_I_HUSSTAND_BELØP(
        "UnderholdEgneBarnIHusstandBeløp",
        "0019",
        true,
        false,
        false,
    ...
    BARNETILLEGG_FORSVARET_FØRSTE_BARN_BELØP(
        "BarnetilleggForsvaretFørsteBarnBeløp",
        "0021",
        false,
        false,
        false,
    ...
    BARNETILLEGG_FORSVARET_ØVRIGE_BARN_BELØP(
        "BarnetilleggForsvaretØvrigeBarnBeløp",
        "0022",
        false,
        false,
        false,
    ...
    GJENNOMSNITT_VIRKEDAGER_PR_MÅNED_ANTALL(
        "GjennomsnittVirkedagerPrMånedAntall",
        "0024",
        false,
        false,
        false,
    ...
    ØVRE_INNTEKTSGRENSE_IKKE_I_SKATTEPOSISJON_BELØP(
        "ØvreInntektsgrenseIkkeISkatteposisjonBeløp",
        "0030",
        false,
        false,
        false,
    ...
    NEDRE_INNTEKTSGRENSE_FULL_SKATTEPOSISJON_BELØP(
        "NedreInntektsgrenseFullSkatteposisjonBeløp",
        "0031",
        false,
        false,
        false,
    ...
    ØVRE_INNTEKTSGRENSE_FULLT_FORSKUDD_BELØP(
        "ØvreInntektsgrenseFulltForskuddBeløp",
        "0033",
        false,
        false,
        false,
    ...
    ØVRE_INNTEKTSGRENSE_75PROSENT_FORSKUDD_EN_BELØP(
        "ØvreInntektsgrense75ProsentForskuddEnBeløp",
        "0034",
        false,
        false,
        false,
    ...
    ØVRE_INNTEKTSGRENSE_75PROSENT_FORSKUDD_GS_BELØP(
        "ØvreInntektsgrense75ProsentForskuddGSBeløp",
        "0035",
        false,
        false,
        false,
    ...
    INNTEKTSINTERVALL_FORSKUDD_BELØP(
        "InntektsintervallForskuddBeløp",
        "0036",
        false,
        false,
        false,
